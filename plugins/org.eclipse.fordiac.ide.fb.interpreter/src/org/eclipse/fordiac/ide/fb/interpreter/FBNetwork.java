...
public class FBNetwork extends FBWithNetwork {

	public FBNetwork(final EventOccurrence eventOccurrence) {
	...
	public EList<EventOccurrence> run(final FBNetworkRuntime fBNetworkRuntime) {
		...
		if (eventOccurrence.getParentFB() instanceof final UntypedSubApp uSubApp) {
			return new UntypedSubApplication(eventOccurrence).run(fBNetworkRuntime, uSubApp);
		}
