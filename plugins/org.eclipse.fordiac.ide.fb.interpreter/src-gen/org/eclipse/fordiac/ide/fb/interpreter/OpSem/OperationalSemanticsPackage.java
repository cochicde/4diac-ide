...
public interface OperationalSemanticsPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int EVENT_MANAGER__START_TIME = 2;
	 ...
	 * @ordered
	 */
	int EVENT_MANAGER_FEATURE_COUNT = 3;
	...
	/**
	 * The meta object id for the
	 * '{@link org.eclipse.fordiac.ide.fb.interpreter.OpSem.impl.FunctionFBTypeRuntimeImpl
	 * <em>Function FB Type Runtime</em>}' class. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 * @see org.eclipse.fordiac.ide.fb.interpreter.OpSem.impl.FunctionFBTypeRuntimeImpl
	 * @see org.eclipse.fordiac.ide.fb.interpreter.OpSem.impl.OperationalSemanticsPackageImpl#getFunctionFBTypeRuntime()
	 * @generated
	 */
	...
	/**
	 * The feature id for the '<em><b>Input Variables</b></em>' containment
	 * reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @generated
	 * @ordered
	...
	/**
	 * The meta object id for the
	 * '{@link org.eclipse.fordiac.ide.fb.interpreter.OpSem.impl.TraceImpl
	...
	/**
	 * The meta object id for the
	 * '{@link org.eclipse.fordiac.ide.fb.interpreter.OpSem.impl.EccTraceImpl
	...
	/**
	 * The number of structural features of the '<em>Ecc Trace</em>' class. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @generated
	 * @ordered
	...
	/**
	 * The meta object id for the
	 * '{@link org.eclipse.fordiac.ide.fb.interpreter.OpSem.impl.TransitionTraceImpl
	...
	/**
	 * The feature id for the '<em><b>Cond Event</b></em>' attribute. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @generated
	 * @ordered
	...
	/**
	 * The feature id for the '<em><b>Cond Expression</b></em>' attribute. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @generated
	 * @ordered
	...
	/**
	 * The number of structural features of the '<em>Transition Trace</em>' class.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @generated
	 * @ordered
	...
	/**
	 * Returns the meta object for the containment reference
	 * '{@link org.eclipse.fordiac.ide.fb.interpreter.OpSem.EventOccurrence#getResultFBRuntime
	 * <em>Result FB Runtime</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @return the meta object for the containment reference '<em>Result FB
	 *         Runtime</em>'.
	 ...
	 *
	 * @return the meta object for the attribute '<em>Start Time</em>'.
	 * @see org.eclipse.fordiac.ide.fb.interpreter.OpSem.EventManager#getStartTime()
	 * @see #getEventManager()
	 * @generated
	 */
	EAttribute getEventManager_StartTime();
	 ...
	 * <em>Function FB Type Runtime</em>}'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 * @return the meta object for class '<em>Function FB Type Runtime</em>'.
	 * @see org.eclipse.fordiac.ide.fb.interpreter.OpSem.FunctionFBTypeRuntime
	 * @generated
	 */
	EClass getFunctionFBTypeRuntime();

	/**
	 * Returns the meta object for the containment reference
	 * '{@link org.eclipse.fordiac.ide.fb.interpreter.OpSem.FunctionFBTypeRuntime#getFunctionFBType
	 * <em>Function FB Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @return the meta object for the containment reference '<em>Function FB
	 *         Type</em>'.
	 * @see org.eclipse.fordiac.ide.fb.interpreter.OpSem.FunctionFBTypeRuntime#getFunctionFBType()
	 * @see #getFunctionFBTypeRuntime()
	 * @generated
	 */
	 ...
	 * @see org.eclipse.fordiac.ide.fb.interpreter.OpSem.Transaction#getDuration()
	 * @see #getTransaction()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the containment reference
	 * '{@link org.eclipse.fordiac.ide.fb.interpreter.OpSem.FBTransaction#getTrace
	...
	/**
	 * Returns the meta object for class
	 * '{@link org.eclipse.fordiac.ide.fb.interpreter.OpSem.Trace <em>Trace</em>}'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	...
	/**
	 * Returns the meta object for class
	 * '{@link org.eclipse.fordiac.ide.fb.interpreter.OpSem.EccTrace <em>Ecc
	...
	/**
	 * Returns the meta object for the containment reference list
	 * '{@link org.eclipse.fordiac.ide.fb.interpreter.OpSem.EccTrace#getTransitionTraces
	 * <em>Transition Traces</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @return the meta object for the containment reference list '<em>Transition
	 *         Traces</em>'.
	 ...
	 * <em>Source State</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 ...
	 * <em>Destination State</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 ...
	 * <em>Cond Event</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 ...
	 * <em>Cond Expression</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Result FB Runtime</b></em>'
		 ...
		 * @generated
		 */
		EAttribute EVENT_MANAGER__START_TIME = eINSTANCE.getEventManager_StartTime();
		...
		/**
		 * The meta object literal for the '<em><b>Active State</b></em>' attribute
		 * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 *
		 * @generated
		 */
		 ...
		 * @generated
		 */
		EClass FUNCTION_FB_TYPE_RUNTIME = eINSTANCE.getFunctionFBTypeRuntime();

		/**
		 * The meta object literal for the '<em><b>Function FB Type</b></em>'
		 * containment reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 *
		 * @generated
		 */
		...
		/**
		 * The meta object literal for the '<em><b>Parent EO</b></em>' reference
		 * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 *
		 * @generated
		 */
		...
		/**
		 * The meta object literal for the '<em><b>Input Variables</b></em>' containment
		 * reference list feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 *
		 * @generated
		 */
		...
		/**
		 * The meta object literal for the '<em><b>Trace</b></em>' containment reference
		 * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 *
		 * @generated
		 */
		...
		/**
		 * The meta object literal for the '<em><b>Transition Traces</b></em>'
		 * containment reference list feature. <!-- begin-user-doc --> <!-- end-user-doc
		 * -->
		 *
		 * @generated
		...
		/**
		 * The meta object literal for the '<em><b>Source State</b></em>' attribute
		 * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 *
		 * @generated
		 */
		...
		/**
		 * The meta object literal for the '<em><b>Destination State</b></em>' attribute
		 * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 *
		 * @generated
		 */
		...
		/**
		 * The meta object literal for the '<em><b>Cond Event</b></em>' attribute
		 * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 *
		 * @generated
		 */
		...
		/**
		 * The meta object literal for the '<em><b>Cond Expression</b></em>' attribute
		 * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 *
		 * @generated
		 */
